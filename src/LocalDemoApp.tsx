...
const collectionPayments: PaymentHistoryItem[] = [
  {
    id: 'pay-1',
    receipt_number: 'RC-260731-001',
    received_amount: 8500,
    allocated_amount: 8500,
    change_amount: 0,
    payment_method: 'cash',
    status: 'active',
    recorded_at: '2026-07-31T09:40:00.000Z',
    void_reason: null,
    building_id: 'b-a',
    ...
    zone_name: 'โซน 1',
    image_path: null,
    image_url: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=240&q=80',
    shops: { code: 'DD1', name: 'ร้านอาหารบ้านสวนริมคลองมหาสวัสดิ์ สาขา 1 (อาหารตามสั่งและเครื่องดื่มสมุนไพร)' },
  },
  {
    id: 'pay-2',
    receipt_number: 'RC-260731-002',
    received_amount: 3850,
    allocated_amount: 3850,
    change_amount: 0,
    payment_method: 'bank_transfer',
    status: 'active',
    recorded_at: '2026-07-31T10:15:00.000Z',
    void_reason: null,
    building_id: 'b-a',
    building_name: 'อาคาร A',
    zone_id: 'z-a2',
    ...
    image_path: null,
    image_url: null,
    shops: { code: 'AA4', name: 'ร้านครัวคุณเงินลุงทอง' },
  },
  {
    id: 'pay-3',
    receipt_number: 'RC-260731-003',
    received_amount: 9850,
    allocated_amount: 9850,
    change_amount: 0,
    payment_method: 'qr',
    status: 'voided',
    void_reason: 'คีย์ยอดรับเงินผิดพลาด',
    ...
    zone_name: 'โซน 1',
    image_path: null,
    image_url: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&fit=crop&w=240&q=80',
    shops: { code: 'BB2', name: 'ร้านกาแฟ ลานเล่า' },
  },
  {
    id: 'pay-4',
    receipt_number: 'RC-260731-004',
    ...
    building_id: null,
    building_name: 'อาคารอิมแพ็ค ชาเลนเจอร์',
    zone_id: null,
    zone_name: 'โซนอาหาร A',
    event_name: 'มหกรรมอาหารและเครื่องดื่ม 2026',
    event_location: 'อาคารอิมแพ็ค ชาเลนเจอร์',
    event_zone: 'โซนอาหาร A',
    event_booth: 'B-12',
    image_path: null,
    image_url: 'https://images.unsplash.com/photo-1558857563-b37cf5a0fec7?auto=format&fit=crop&w=240&q=80',
    shops: { code: 'EV01', name: 'ชานมไข่มุกไต้หวัน ต้นตำรับ' },
  },
  {
    id: 'pay-5',
    receipt_number: 'RC-260730-001',
    received_amount: 7400,
    allocated_amount: 7400,
    change_amount: 0,
    payment_method: 'cash',
    status: 'active',
    recorded_at: '2026-07-30T09:15:00.000Z',
    void_reason: null,
    building_id: 'b-c',
    ...
    zone_name: 'โซน 1',
    image_path: null,
    image_url: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=240&q=80',
    shops: { code: 'CC1', name: 'ร้านอาหารเจริญรส' },
  },
  {
    id: 'pay-6',
    receipt_number: 'RC-260730-002',
    ...
    image_path: null,
    image_url: null,
    shops: { code: 'CC3', name: 'ร้านผลไม้สด' },
  },
];
...
const managerDashboardDemo: DailyWorkDashboard = {
  ...
  deliverySummary: {
    activeDeliveryCount: 48,
    actualShopCount: 31,
    problemCount: 2,
    regularDeliveryCount: 48,
    regularShopCount: 31,
    regularProblemCount: 2,
  ...
  salesSummary: {
    ...
    iceTypeSales: [
      { ice_type_id: 'ice-block', ice_type_name: 'หลอดเล็ก', unit: 'ถุง', quantity: 72 },
      { ice_type_id: 'ice-small', ice_type_name: 'หลอดเล็กโม่', unit: 'ถุง', quantity: 28 },
...
function buildDemoGateway(): EmployeeDeliveryGateway & { reset(): void } {
  ...
  return {
    ...
    async recordEmployeeStockReturn(payload: EmployeeStockTransferPayload) {
      await delay(180);
      if (!transferKeys.has(payload.idempotencyKey)) {
        transferKeys.add(payload.idempotencyKey);
        for (const item of payload.items) {
