...
begin
  for target in select * from target_receipts order by shop_code loop
    ...
    insert into public.payments(
      ...
      'active','5047b139-345c-4173-b3dd-b5fe5a13bd2e'::uuid,now()
    );
    ...
    values('5047b139-345c-4173-b3dd-b5fe5a13bd2e'::uuid,'payments',target.payment_id,'imported_excel_followup',jsonb_build_object(
